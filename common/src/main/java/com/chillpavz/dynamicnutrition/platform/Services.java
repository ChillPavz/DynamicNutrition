...
public class Services {
    ...
    public static final INutritionStorage STORAGE = load(INutritionStorage.class);

    /** Per-loader packet sending. Only the food table needs one; the player's values ride the attachment. */
    public static final INetworkSender NETWORK = load(INetworkSender.class);
